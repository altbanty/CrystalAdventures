...
WhitneyGroup:
	...
	; WHITNEY (3): Snubbull / Girafarig / Smeargle / Miltank
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, SNUBBULL,   NO_ITEM,       HEADBUTT, SCARY_FACE, CHARM, BITE
	db 19, GIRAFARIG,  NO_ITEM,       STOMP, CONFUSION, AGILITY, PSYBEAM
...
MortyGroup:
	...
	; MORTY (3): Noctowl / Misdreavus / Umbreon / Gengar
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	...
	db 24, UMBREON,     NO_ITEM,       FAINT_ATTACK, CONFUSE_RAY, PURSUIT, MEAN_LOOK
	db 25, GENGAR,      MIRACLEBERRY,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
