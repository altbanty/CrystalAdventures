...
JasmineGroup:
	...
	db 54, MAGNETON,   NO_ITEM,       ROLLOUT, TOXIC, RAIN_DANCE, THUNDER
...
ChuckGroup:
	...
	db 29, MACHOKE,   NO_ITEM,      KARATE_CHOP, THUNDERPUNCH, VITAL_THROW, SEISMIC_TOSS
	db 30, SUDOWOODO, NO_ITEM,      ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 31, POLIWRATH, BLACKBELT_I,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
	...
	db 35, SUDOWOODO, NO_ITEM,      ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 34, MACHOKE,   NO_ITEM,      KARATE_CHOP, THUNDERPUNCH, VITAL_THROW, SEISMIC_TOSS
	...
	db 37, SUDOWOODO,  NO_ITEM,       ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 37, MACHAMP,    NO_ITEM,       CROSS_CHOP, THUNDERPUNCH, VITAL_THROW, SCARY_FACE
