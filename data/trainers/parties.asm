...
FalknerGroup:
	; FALKNER (1): Pidgey / Noctowl / Xatu
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  8,  PIDGEY,   NO_ITEM,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db  9,  NOCTOWL,  NO_ITEM,  MUD_SLAP, PECK, GROWL, FORESIGHT
	db  10, XATU,     BERRY,    PECK, NIGHT_SHADE, CONFUSION, LEER
	db -1 ; end

	; FALKNER (2): Spearow / Pidgeotto / Xatu
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  8,  SPEAROW,   NO_ITEM,  PECK, GROWL, LEER, NO_MOVE
	db  9,  PIDGEOTTO, NO_ITEM,  TACKLE, SAND_ATTACK, GUST, QUICK_ATTACK
	db  10, XATU,      BERRY,    PECK, NIGHT_SHADE, CONFUSION, LEER
	db -1 ; end

	; FALKNER (3): Natu / Pidgeotto / Noctowl
	db "FALKNER@", TRAINERTYPE_ITEM_MOVES
	db  8,  NATU,      NO_ITEM,  PECK, LEER, CONFUSION, NO_MOVE
	db  9,  PIDGEOTTO, NO_ITEM,  TACKLE, SAND_ATTACK, GUST, QUICK_ATTACK
	db  10, NOCTOWL,   BERRY,    MUD_SLAP, PECK, GROWL, FORESIGHT
	db -1 ; end
...
WhitneyGroup:
	; WHITNEY (1): Clefairy / Teddiursa / Smeargle / Miltank
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, CLEFAIRY,   NO_ITEM,       HEADBUTT, CHARM, ICE_PUNCH, METRONOME
	db 19, TEDDIURSA,  NO_ITEM,       HEADBUTT, METAL_CLAW, LICK, MUD_SLAP
	db 20, SMEARGLE,   NO_ITEM,       SPORE, SEISMIC_TOSS, MUD_SLAP, ENCORE
	db 21, MILTANK,    MIRACLEBERRY,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (2): Jigglypuff / Furret / Smeargle / Miltank
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, JIGGLYPUFF, NO_ITEM,       SING, POUND, DEFENSE_CURL, ROLLOUT
	db 19, FURRET,     NO_ITEM,       HEADBUTT, QUICK_ATTACK, FURY_SWIPES, DEFENSE_CURL
	db 20, SMEARGLE,   NO_ITEM,       THUNDER_WAVE, COUNTER, PURSUIT, SEISMIC_TOSS
	db 21, MILTANK,    MIRACLEBERRY,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

	; WHITNEY (3): Snubbull / Togetic / Smeargle / Miltank
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 19, SNUBBULL,   NO_ITEM,       HEADBUTT, SCARY_FACE, CHARM, BITE
	db 19, TOGETIC,    NO_ITEM,       CHARM, SWEET_KISS, METRONOME, HEADBUTT
	db 20, SMEARGLE,   NO_ITEM,       LOVELY_KISS, REFLECT, DESTINY_BOND, SEISMIC_TOSS
	db 21, MILTANK,    MIRACLEBERRY,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
BugsyGroup:
	...
	; BUGSY (2): Butterfree / Ariados / Scyther
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 15, BUTTERFREE, NO_ITEM,   CONFUSION, POISONPOWDER, STUN_SPORE, GUST
	db 15, ARIADOS,    NO_ITEM,   FURY_CUTTER, SCARY_FACE, POISON_STING, NIGHT_SHADE
	db 16, SCYTHER,    BERRY_JUICE, QUICK_ATTACK, FURY_CUTTER, CUT, PURSUIT
	db -1 ; end

	; BUGSY (3): Yanma / Beedrill / Scyther
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 15, YANMA,    NO_ITEM,     QUICK_ATTACK, SUPERSONIC, SONICBOOM, FORESIGHT
	db 15, BEEDRILL, NO_ITEM,     FURY_ATTACK, TWINEEDLE, RAGE, PURSUIT
	db 16, SCYTHER,  BERRY_JUICE, QUICK_ATTACK, FURY_CUTTER, CUT, PURSUIT
	db -1 ; end
...
MortyGroup:
	; MORTY (1): Stantler / Haunter / Misdreavus / Gengar
	...
	; MORTY (2): Murkrow / Haunter / Hypno / Gengar
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 23, MURKROW,     NO_ITEM,       PURSUIT, NIGHT_SHADE, FAINT_ATTACK, HAZE
	db 24, HAUNTER,     NO_ITEM,       HYPNOSIS, SHADOW_BALL, CURSE, NIGHT_SHADE
	db 24, HYPNO,       NO_ITEM,       HYPNOSIS, DREAM_EATER, HEADBUTT, DISABLE
	db 25, GENGAR,      MIRACLEBERRY,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end

	; MORTY (3): Noctowl / Misdreavus / Girafarig / Gengar
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 23, NOCTOWL,     NO_ITEM,       HYPNOSIS, DREAM_EATER, CONFUSION, REFLECT
	db 24, MISDREAVUS,  NO_ITEM,       SHADOW_BALL, PSYBEAM, PERISH_SONG, PAIN_SPLIT
	db 24, GIRAFARIG,   NO_ITEM,       STOMP, PSYBEAM, CONFUSE_RAY, SHADOW_BALL
	db 25, GENGAR,      MIRACLEBERRY,  HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db -1 ; end
...
PryceGroup:
	; PRYCE 1: Tier 1 Variant A (4 badges, original)
	...
	; PRYCE 2: Tier 1 Variant B (no Jynx, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 31, LAPRAS,     NO_ITEM,     SURF, ICE_BEAM, BODY_SLAM, RAIN_DANCE
	db 31, CLOYSTER,   NO_ITEM,     SURF, SPIKES, AURORA_BEAM, PROTECT
	db 32, SNEASEL,    NO_ITEM,     FAINT_ATTACK, METAL_CLAW, REFLECT, ICY_WIND
	db 33, PILOSWINE,  GOLD_BERRY,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end

	; PRYCE 3: Tier 1 Variant C (no Sneasel, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 31, DEWGONG,    NO_ITEM,     SURF, AURORA_BEAM, RAIN_DANCE, REST
	db 31, LAPRAS,     NO_ITEM,     SURF, ICE_BEAM, BODY_SLAM, CONFUSE_RAY
	db 31, CLOYSTER,   NO_ITEM,     SURF, SPIKES, AURORA_BEAM, PROTECT
	db 33, PILOSWINE,  GOLD_BERRY,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end

	; PRYCE 4: Tier 2 Variant A (5 badges, original)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	...
	; PRYCE 5: Tier 2 Variant B (no Jynx, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 33, LAPRAS,    NO_ITEM,      SURF, ICE_BEAM, BODY_SLAM, RAIN_DANCE
	db 34, SNEASEL,   NO_ITEM,      FAINT_ATTACK, METAL_CLAW, REFLECT, ICE_PUNCH
	db 33, CLOYSTER,  NO_ITEM,      SURF, SPIKES, AURORA_BEAM, PROTECT
	db 34, DEWGONG,   NO_ITEM,      SURF, AURORA_BEAM, SNORE, REST
	db 35, PILOSWINE, GOLD_BERRY,   HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end

	; PRYCE 6: Tier 2 Variant C (no Sneasel, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 33, LAPRAS,    NO_ITEM,      SURF, ICE_BEAM, BODY_SLAM, CONFUSE_RAY
	db 33, JYNX,      NO_ITEM,      ICE_PUNCH, PSYCHIC_M, RAIN_DANCE, LOVELY_KISS
	db 33, CLOYSTER,  NO_ITEM,      SURF, SPIKES, AURORA_BEAM, PROTECT
	db 34, DEWGONG,   NO_ITEM,      SURF, AURORA_BEAM, SNORE, REST
	db 35, PILOSWINE, GOLD_BERRY,   HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	...
	; PRYCE 7: Tier 3 Variant A (6 badges, original)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	...
	; PRYCE 8: Tier 3 Variant B (no Jynx, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 37, LAPRAS,      NO_ITEM,     SURF, ICE_BEAM, BODY_SLAM, RAIN_DANCE
	db 37, SNEASEL,     NO_ITEM,     FAINT_ATTACK, METAL_CLAW, REFLECT, BLIZZARD
	db 37, CLOYSTER,    NO_ITEM,     SURF, SPIKES, AURORA_BEAM, PROTECT
	db 37, DEWGONG,     NO_ITEM,     SURF, AURORA_BEAM, SNORE, REST
	db 38, PILOSWINE,   GOLD_BERRY,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
	db -1 ; end

	; PRYCE 9: Tier 3 Variant C (no Sneasel, has Lapras)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 37, LAPRAS,      NO_ITEM,     SURF, ICE_BEAM, BODY_SLAM, CONFUSE_RAY
	db 37, JYNX,        NO_ITEM,     ICE_PUNCH, PSYCHIC_M, SHADOW_BALL, LOVELY_KISS
	db 37, CLOYSTER,    NO_ITEM,     SURF, SPIKES, AURORA_BEAM, PROTECT
	db 37, DEWGONG,     NO_ITEM,     SURF, AURORA_BEAM, SNORE, REST
	db 38, PILOSWINE,   GOLD_BERRY,  HEADBUTT, EARTHQUAKE, ROCK_SMASH, BLIZZARD
...
JasmineGroup:
	; JASMINE 1: Tier 1 Variant A (4 badges, original — Scizor+Corsola)
	...
	; JASMINE 2: Tier 1 Variant B (Ampharos+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 35, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, AMPHAROS,   NO_ITEM,     THUNDERBOLT, THUNDER_WAVE, FIRE_PUNCH, LIGHT_SCREEN
	db 35, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 36, FORRETRESS, NO_ITEM,     SPIKES, RAPID_SPIN, DOUBLE_EDGE, EXPLOSION
	db 36, STEELIX,    QUICK_CLAW,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

	; JASMINE 3: Tier 1 Variant C (Mantine+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 35, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, MANTINE,    NO_ITEM,     SURF, ICE_BEAM, CONFUSE_RAY, RAIN_DANCE
	db 35, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 36, FORRETRESS, NO_ITEM,     SPIKES, RAPID_SPIN, DOUBLE_EDGE, EXPLOSION
	db 36, STEELIX,    QUICK_CLAW,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

	; JASMINE 4: Tier 2 Variant A (5 badges, original — Scizor+Corsola)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 35, SKARMORY, NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, CORSOLA,  NO_ITEM,     RAIN_DANCE, SURF, RECOVER, ANCIENTPOWER
	db 35, MAGNETON, NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	...
	; JASMINE 5: Tier 2 Variant B (Ampharos+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 35, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, AMPHAROS,   NO_ITEM,     THUNDERBOLT, THUNDER_WAVE, FIRE_PUNCH, LIGHT_SCREEN
	db 35, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	...
	; JASMINE 6: Tier 2 Variant C (Mantine+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 35, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 35, MANTINE,    NO_ITEM,     SURF, ICE_BEAM, CONFUSE_RAY, RAIN_DANCE
	db 35, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	...
	; JASMINE 7: Tier 3 Variant A (6 badges, original — Scizor+Corsola)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	...
	; JASMINE 8: Tier 3 Variant B (Ampharos+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 37, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 37, AMPHAROS,   NO_ITEM,     THUNDERBOLT, THUNDER_WAVE, FIRE_PUNCH, LIGHT_SCREEN
	db 37, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 38, FORRETRESS, NO_ITEM,     SPIKES, RAPID_SPIN, DOUBLE_EDGE, EXPLOSION
	db 38, STEELIX,    QUICK_CLAW,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

	; JASMINE 9: Tier 3 Variant C (Mantine+Forretress)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 37, SKARMORY,   NO_ITEM,     SPIKES, DRILL_PECK, SWAGGER, STEEL_WING
	db 37, MANTINE,    NO_ITEM,     SURF, ICE_BEAM, CONFUSE_RAY, RAIN_DANCE
	db 37, MAGNETON,   NO_ITEM,     THUNDERBOLT, TRI_ATTACK, RAIN_DANCE, THUNDER
	db 38, FORRETRESS, NO_ITEM,     SPIKES, RAPID_SPIN, DOUBLE_EDGE, EXPLOSION
	db 38, STEELIX,    QUICK_CLAW,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end
...
ChuckGroup:
	; CHUCK 1: Tier 1 Variant A (4 badges, original)
	...
	; CHUCK 2: Tier 1 Variant B (unique: Hitmonlee)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 30, HITMONLEE, NO_ITEM,      ROLLING_KICK, JUMP_KICK, MEDITATE, HEADBUTT
	db 29, MACHOKE,   NO_ITEM,      KARATE_CHOP, ROCK_SLIDE, VITAL_THROW, SEISMIC_TOSS
	db 30, SUDOWOODO, NO_ITEM,      ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 31, POLIWRATH, BLACKBELT_I,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 3: Tier 1 Variant C (unique: Hitmonchan, Heracross)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 30, HITMONCHAN, NO_ITEM,     THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 29, PRIMEAPE,   NO_ITEM,     LOW_KICK, KARATE_CHOP, ICE_PUNCH, RAGE
	db 30, HERACROSS,  NO_ITEM,     HORN_ATTACK, FURY_CUTTER, ENDURE, REVERSAL
	db 31, POLIWRATH,  BLACKBELT_I, HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 4: Tier 2 Variant A (5 badges, original)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	...
	; CHUCK 5: Tier 2 Variant B (unique: Hitmonlee, Heracross)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 35, HITMONLEE, NO_ITEM,      ROLLING_KICK, JUMP_KICK, MEDITATE, HI_JUMP_KICK
	db 35, SUDOWOODO, NO_ITEM,      ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 34, MACHOKE,   NO_ITEM,      KARATE_CHOP, ROCK_SLIDE, VITAL_THROW, SEISMIC_TOSS
	db 35, HERACROSS, NO_ITEM,      HORN_ATTACK, FURY_CUTTER, ENDURE, REVERSAL
	db 36, POLIWRATH, BLACKBELT_I,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 6: Tier 2 Variant C (unique: Hitmonchan)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 35, HITMONCHAN, NO_ITEM,     THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 34, PRIMEAPE,   NO_ITEM,     LOW_KICK, KARATE_CHOP, ICE_PUNCH, RAGE
	db 35, PINSIR,     NO_ITEM,     ROCK_SMASH, TWINEEDLE, VICEGRIP, HARDEN
	db 35, MACHOKE,    NO_ITEM,     KARATE_CHOP, ROCK_SLIDE, VITAL_THROW, SEISMIC_TOSS
	db 36, POLIWRATH,  BLACKBELT_I, HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 7: Tier 3 Variant A (6 badges, original)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	...
	; CHUCK 8: Tier 3 Variant B (unique: Hitmonlee, Heracross)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 37, HITMONLEE,  NO_ITEM,       ROLLING_KICK, JUMP_KICK, MEDITATE, HI_JUMP_KICK
	db 37, SUDOWOODO,  NO_ITEM,       ROCK_SLIDE, THUNDERPUNCH, LOW_KICK, FAINT_ATTACK
	db 37, MACHAMP,    NO_ITEM,       CROSS_CHOP, ROCK_SLIDE, VITAL_THROW, SCARY_FACE
	db 37, HERACROSS,  NO_ITEM,       MEGAHORN, FURY_CUTTER, ENDURE, REVERSAL
	db 38, POLIWRATH,  BLACKBELT_I,   ICE_PUNCH, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 9: Tier 3 Variant C (unique: Hitmonchan)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 37, HITMONCHAN, NO_ITEM,       THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, MACH_PUNCH
	db 37, PRIMEAPE,   NO_ITEM,       DYNAMICPUNCH, KARATE_CHOP, ROCK_SLIDE, RAGE
	db 37, PINSIR,     NO_ITEM,       SUBMISSION, TWINEEDLE, STRENGTH, SWORDS_DANCE
	db 37, MACHOKE,    NO_ITEM,       KARATE_CHOP, ROCK_SLIDE, VITAL_THROW, SEISMIC_TOSS
	db 38, POLIWRATH,  BLACKBELT_I,   ICE_PUNCH, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end

	; CHUCK 10: Rematch
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 54, HITMONTOP,  SCOPE_LENS,    TRIPLE_KICK, MACH_PUNCH, DIG, PURSUIT
...
ClairGroup:
	...
	; CLAIR (2): Full Offense
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 42, DRAGONAIR,  MIRACLEBERRY,    DRAGONBREATH, FIRE_BLAST, THUNDER, HYPER_BEAM
	db 43, GYARADOS,   SCOPE_LENS,      WATERFALL, HYPER_BEAM, BITE, DRAGON_RAGE
	db 43, LAPRAS,     GOLD_BERRY,      SURF, BLIZZARD, THUNDERBOLT, PSYCHIC_M
	db 44, DRAGONAIR,  FOCUS_BAND,      DRAGONBREATH, FLAMETHROWER, ICE_BEAM, HYPER_BEAM
	db 45, KINGDRA,    LEFTOVERS,       SURF, DRAGONBREATH, ICE_BEAM, HYPER_BEAM
	db -1 ; end

	; CLAIR (3): Rain Disruption
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 42, DRAGONAIR,  GOLD_BERRY,      THUNDER_WAVE, DRAGONBREATH, SAFEGUARD, ICE_BEAM
	db 43, GYARADOS,   MIRACLEBERRY,    WATERFALL, RAIN_DANCE, BITE, ROAR
	db 43, LAPRAS,     LEFTOVERS,       SURF, ICE_BEAM, THUNDERBOLT, RAIN_DANCE
	db 44, DRAGONAIR,  MINT_BERRY,      THUNDER_WAVE, DRAGONBREATH, FLAMETHROWER, REST
	db 45, KINGDRA,    FOCUS_BAND,      SURF, DRAGONBREATH, SMOKESCREEN, REST
	db -1 ; end
...
;   3 Aipom      -> Totodile line     7 Mareep     -> Chikorita line
	...
	; RIVAL1 (1) - vs Chikorita player
	db "?@", TRAINERTYPE_NORMAL
	db  5, CYNDAQUIL
	db -1 ; end

	; RIVAL1 (2) - vs Totodile player
	db "?@", TRAINERTYPE_NORMAL
	db  5, CHIKORITA
	db -1 ; end

	; RIVAL1 (3) - vs Cyndaquil player
	db "?@", TRAINERTYPE_NORMAL
	db  5, TOTODILE
	db -1 ; end

	; RIVAL1 (4) - vs Aipom player
	db "?@", TRAINERTYPE_NORMAL
	db  5, TOTODILE
	db -1 ; end
	...
	; RIVAL1 (6) - vs Smeargle player
	db "?@", TRAINERTYPE_NORMAL
	db  5, CYNDAQUIL
	db -1 ; end

	; RIVAL1 (7) - vs Swinub player
	db "?@", TRAINERTYPE_NORMAL
	db  5, TOTODILE
	db -1 ; end
	...
	; Pokemon Crystal Adventures: encounter 2 (Azalea)
	; RIVAL1 (9) - vs Chikorita: Fire/Dark offense
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, QUILAVA
	...
	; RIVAL1 (10) - vs Totodile: Grass/Poison stall
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, BAYLEEF
	...
	; RIVAL1 (11) - vs Cyndaquil: Water/Ice bulk
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, CROCONAW
	...
	; RIVAL1 (12) - vs Aipom: Physical bruiser
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, CROCONAW
	...
	; RIVAL1 (14) - vs Smeargle: Speed/special
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, QUILAVA
	...
	; RIVAL1 (15) - vs Swinub: Water/Fire cover
	db "?@", TRAINERTYPE_NORMAL
	db 15, ZUBAT
	db 16, LARVITAR
	db 18, CROCONAW
	...
	; Pokemon Crystal Adventures: encounter 3 (Burned Tower)
	; RIVAL1 (17) - vs Chikorita: Fire/Dark offense
	...
	; RIVAL1 (18) - vs Totodile: Grass/Poison stall
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	...
	; RIVAL1 (19) - vs Cyndaquil: Water/Ice bulk
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	...
	; RIVAL1 (20) - vs Aipom: Physical bruiser
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	db 23, MACHOKE,     KARATE_CHOP, LOW_KICK, LEER, SEISMIC_TOSS
	db 22, GOLBAT,      BITE, CONFUSE_RAY, LEECH_LIFE, GUST
	db 24, CROCONAW,    BITE, ICE_PUNCH, WATER_GUN, MUD_SLAP
	db -1 ; end
	...
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	db 23, WEEPINBELL,  RAZOR_LEAF, GROWTH, SLEEP_POWDER, STUN_SPORE
	db 22, HOOTHOOT,    PECK, HYPNOSIS, REFLECT, CONFUSION
	db 24, BAYLEEF,     MEGA_DRAIN, RAZOR_LEAF, TACKLE, LEECH_SEED
	db -1 ; end

	; RIVAL1 (22) - vs Smeargle: Speed/special
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	db 23, KADABRA,     PSYBEAM, RECOVER, DISABLE, CONFUSION
	db 22, GOLBAT,      BITE, CONFUSE_RAY, LEECH_LIFE, GUST
	db 24, QUILAVA,     FLAME_WHEEL, DIG, QUICK_ATTACK, SMOKESCREEN
	db -1 ; end

	; RIVAL1 (23) - vs Swinub: Water/Fire cover
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	db 23, MAGBY,       EMBER, SMOG, SUNNY_DAY, FIRE_PUNCH
	db 22, GOLBAT,      BITE, CONFUSE_RAY, LEECH_LIFE, GUST
	db 24, CROCONAW,    BITE, ICE_PUNCH, WATER_GUN, MUD_SLAP
	db -1 ; end

	; RIVAL1 (24) - vs Mareep: Ground/Grass anti-Elec
	db "?@", TRAINERTYPE_MOVES
	db 22, LARVITAR,    BITE, ROCK_THROW, SCREECH, NO_MOVE
	db 23, PHANPY,      ROLLOUT, DEFENSE_CURL, TAKE_DOWN, MUD_SLAP
	db 22, HOOTHOOT,    PECK, HYPNOSIS, REFLECT, CONFUSION
	db 24, BAYLEEF,     MEGA_DRAIN, RAZOR_LEAF, TACKLE, LEECH_SEED
	db -1 ; end
	...
	; RIVAL1 (27) - vs Cyndaquil: Water/Ice bulk
	db "?@", TRAINERTYPE_MOVES
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE
	...
	; RIVAL1 (28) - vs Aipom: Physical bruiser
	db "?@", TRAINERTYPE_MOVES
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE
	db 39, MACHAMP,     CROSS_CHOP, ROCK_SLIDE, FORESIGHT, VITAL_THROW
	db 38, STEELIX,     EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, SCREECH
	db 39, GOLBAT,      TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 40, CROCONAW,    BITE, ICE_PUNCH, SURF, MUD_SLAP
	db -1 ; end
	...
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE
	db 39, VICTREEBEL,  SLUDGE, RAZOR_LEAF, SLEEP_POWDER, GROWTH
	db 38, QUAGSIRE,    EARTHQUAKE, SURF, SLUDGE_BOMB, RAIN_DANCE
	db 39, NOCTOWL,     PSYCHIC_M, HYPNOSIS, REFLECT, FLY
	db 40, BAYLEEF,     RAZOR_LEAF, SYNTHESIS, BODY_SLAM, LEECH_SEED
	db -1 ; end

	; RIVAL1 (30) - vs Smeargle: Speed/special
	db "?@", TRAINERTYPE_MOVES
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE
	db 39, ALAKAZAM,    PSYCHIC_M, RECOVER, FIRE_PUNCH, THUNDER_WAVE
	db 38, HOUNDOOM,    FLAMETHROWER, IRON_TAIL, BITE, DOUBLE_TEAM
	db 39, GOLBAT,      TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 40, QUILAVA,     FLAME_WHEEL, DIG, QUICK_ATTACK, IRON_TAIL
	db -1 ; end

	; RIVAL1 (31) - vs Swinub: Water/Fire cover
	db "?@", TRAINERTYPE_MOVES
	db 39, PUPITAR,     THRASH, ROCK_SLIDE, SCREECH, BITE
	db 39, MAGMAR,      FIRE_PUNCH, THUNDERPUNCH, CONFUSE_RAY, SMOKESCREEN
	...
	db 45, URSARING,    MIRACLEBERRY,    SLASH, FAINT_ATTACK, ROCK_SMASH, REST
	db 45, CROBAT,      NO_ITEM,         TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 46, MACHAMP,     NO_ITEM,         CROSS_CHOP, ROCK_SLIDE, FORESIGHT, VITAL_THROW
	db 46, STEELIX,     QUICK_CLAW,      EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, SCREECH
	db 47, FERALIGATR,  MYSTIC_WATER,    ICE_PUNCH, SURF, SLASH, EARTHQUAKE
	db 48, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_PUNCH
	db -1 ; end
	...
	db 46, VICTREEBEL,  NO_ITEM,         SLUDGE_BOMB, GIGA_DRAIN, SLEEP_POWDER, GROWTH
	db 46, QUAGSIRE,    QUICK_CLAW,      EARTHQUAKE, SURF, SLUDGE_BOMB, RAIN_DANCE
	db 47, MEGANIUM,    MIRACLE_SEED,    SUNNY_DAY, GIGA_DRAIN, BODY_SLAM, SYNTHESIS
	db 48, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_PUNCH
	db -1 ; end
	...
	db 45, URSARING,    MIRACLEBERRY,    SLASH, FAINT_ATTACK, ROCK_SMASH, REST
	db 45, CROBAT,      NO_ITEM,         TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 46, ALAKAZAM,    NO_ITEM,         PSYCHIC_M, RECOVER, FIRE_PUNCH, THUNDER_WAVE
	db 46, HOUNDOOM,    QUICK_CLAW,      FLAMETHROWER, IRON_TAIL, CRUNCH, SUNNY_DAY
	db 47, TYPHLOSION,  CHARCOAL,        FLAMETHROWER, THUNDERPUNCH, QUICK_ATTACK, IRON_TAIL
	db 48, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_PUNCH
	db -1 ; end
	...
	db 45, URSARING,    MIRACLEBERRY,    SLASH, FAINT_ATTACK, ROCK_SMASH, REST
	db 45, CROBAT,      NO_ITEM,         TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 46, MAGMAR,      NO_ITEM,         FIRE_PUNCH, THUNDERPUNCH, CONFUSE_RAY, CROSS_CHOP
	db 46, OCTILLERY,   QUICK_CLAW,      SURF, ICE_BEAM, PSYBEAM, HYPER_BEAM
	db 47, FERALIGATR,  MYSTIC_WATER,    ICE_PUNCH, SURF, SLASH, EARTHQUAKE
	db 48, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_PUNCH
	db -1 ; end
...
LassGroup:
	...
	; DANA1_V1
	db "DANA@", TRAINERTYPE_MOVES
	db 19, CLEFAIRY, POUND, ENCORE, DOUBLESLAP, METRONOME
	db 20, GLOOM, ABSORB, POISONPOWDER, STUN_SPORE, SLEEP_POWDER
	db -1 ; end
	; DANA1_V2
	db "DANA@", TRAINERTYPE_MOVES
	db 20, AMPHAROS, HEADBUTT, THUNDERSHOCK, THUNDER_WAVE, COTTON_SPORE
	db -1 ; end
	; CONNIE1_V1
	db "CONNIE@", TRAINERTYPE_NORMAL
	db 22, GROWLITHE
...
CooltrainerMGroup:
	...
	; NICK_V1
	db "NICK@", TRAINERTYPE_MOVES
	db 26, EEVEE, QUICK_ATTACK, SAND_ATTACK, BITE, TAKE_DOWN
	db 26, LARVITAR, BITE, ROCK_THROW, SCREECH, SANDSTORM
	db 26, DRATINI, TWISTER, THUNDER_WAVE, DRAGON_RAGE, SLAM
	db -1 ; end
	; NICK_V2
	db "NICK@", TRAINERTYPE_MOVES
	db 27, CHARMELEON, EMBER, SLASH, SCARY_FACE, RAGE
	db 27, WARTORTLE, WATER_GUN, BITE, WITHDRAW, RAPID_SPIN
	db -1 ; end
	; AARON_V1
	db "AARON@", TRAINERTYPE_NORMAL
	db 27, DRAGONAIR
	...
	; ALLEN_V1
	db "ALLEN@", TRAINERTYPE_MOVES
	db 35, ARCANINE, FLAMETHROWER, BITE, TAKE_DOWN, NO_MOVE
	db 37, AMPHAROS, THUNDERPUNCH, THUNDER_WAVE, HEADBUTT, NO_MOVE
	db -1 ; end
	; ALLEN_V2
	db "ALLEN@", TRAINERTYPE_MOVES
	db 37, MAGMAR, FIRE_PUNCH, CONFUSE_RAY, SMOKESCREEN, THUNDERPUNCH
	db -1 ; end
	; RYAN_V1
	db "RYAN@", TRAINERTYPE_MOVES
	db 37, NOCTOWL, HYPNOSIS, DREAM_EATER, WING_ATTACK, REFLECT
	db 37, AMPHAROS, THUNDERPUNCH, THUNDER_WAVE, SWIFT, NO_MOVE
	db 37, ARCANINE, FLAMETHROWER, BITE, TAKE_DOWN, NO_MOVE
	db -1 ; end
	; RYAN_V2
	db "RYAN@", TRAINERTYPE_MOVES
	db 38, PIDGEOT, WING_ATTACK, QUICK_ATTACK, STEEL_WING, MUD_SLAP
	db 38, MAGMAR, FIRE_PUNCH, THUNDERPUNCH, CONFUSE_RAY, SMOKESCREEN
	db -1 ; end
...
CooltrainerFGroup:
	...
	; LOIS_V1
	db "LOIS@", TRAINERTYPE_MOVES
	db 28, SUNFLORA, SUNNY_DAY, MEGA_DRAIN, GROWTH, RAZOR_LEAF
	db 27, ARCANINE, FLAMETHROWER, BITE, TAKE_DOWN, ROAR
	db -1 ; end
	; LOIS_V2
	db "LOIS@", TRAINERTYPE_MOVES
	db 28, VICTREEBEL, RAZOR_LEAF, SLEEP_POWDER, ACID, GROWTH
	db -1 ; end
...
FisherGroup:
	...
	; EDGAR_V1
	db "EDGAR@", TRAINERTYPE_MOVES
	db 38, LANTURN, THUNDERBOLT, SURF, CONFUSE_RAY, THUNDER_WAVE
	db 36, QWILFISH, PIN_MISSILE, SURF, TOXIC, MINIMIZE
	db 36, TENTACRUEL, SURF, SLUDGE_BOMB, BARRIER, WRAP
	db -1 ; end
	; EDGAR_V2
	db "EDGAR@", TRAINERTYPE_MOVES
	db 38, GYARADOS, SURF, DRAGON_RAGE, BITE, TWISTER
	db 37, SEAKING, WATERFALL, HORN_ATTACK, FURY_ATTACK, SUPERSONIC
	db -1 ; end
...
SwimmerFGroup:
	...
	; SUSIE_V1
	db "SUSIE@", TRAINERTYPE_MOVES
	db 27, STARMIE, SURF, SWIFT, RECOVER, CONFUSE_RAY
	db 26, CORSOLA, BUBBLEBEAM, ROCK_THROW, RECOVER, MIRROR_COAT
	db -1 ; end
	; SUSIE_V2
	db "SUSIE@", TRAINERTYPE_MOVES
	db 28, GOLDUCK, SURF, CONFUSION, SCRATCH, DISABLE
	db -1 ; end
	; DENISE_V1
	db "DENISE@", TRAINERTYPE_NORMAL
	db 27, DEWGONG
	...
	; WENDY_V1
	db "WENDY@", TRAINERTYPE_MOVES
	db 26, STARYU, SWIFT, BUBBLEBEAM, RECOVER, RAPID_SPIN
	db 27, TENTACRUEL, SURF, BARRIER, WRAP, ACID
	db -1 ; end
	; WENDY_V2
	db "WENDY@", TRAINERTYPE_MOVES
	db 28, SEADRA, SURF, SMOKESCREEN, TWISTER, DRAGON_RAGE
	db -1 ; end
...
SuperNerdGroup:
	...
	; MARKUS_V1
	db "MARKUS@", TRAINERTYPE_MOVES
	db 19, MAGNEMITE, THUNDERSHOCK, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db -1 ; end
	; MARKUS_V2
	...
	; HUGH_V1
	db "HUGH@", TRAINERTYPE_MOVES
	db 39, LANTURN, SURF, THUNDERBOLT, CONFUSE_RAY, THUNDER_WAVE
	db -1 ; end
	; HUGH_V2
	db "HUGH@", TRAINERTYPE_MOVES
	db 38, TENTACRUEL, SURF, SLUDGE_BOMB, BARRIER, WRAP
	db 38, CHINCHOU, SURF, SPARK, CONFUSE_RAY, THUNDER_WAVE
	db -1 ; end
...
; Same 11 team themes as RIVAL1, fully evolved with best movesets.
	...
	; RIVAL2 (4) - vs Aipom: Physical bruiser
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 64, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 64, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 64, MACHAMP,     SCOPE_LENS,      CROSS_CHOP, ROCK_SLIDE, FORESIGHT, VITAL_THROW
	db 64, STEELIX,     QUICK_CLAW,      EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, SCREECH
	db 64, FERALIGATR,  MYSTIC_WATER,    ICE_BEAM, SURF, SLASH, EARTHQUAKE
	db 64, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
	...
	db 64, VICTREEBEL,  SCOPE_LENS,      SLUDGE_BOMB, GIGA_DRAIN, SLEEP_POWDER, GROWTH
	db 64, QUAGSIRE,    QUICK_CLAW,      EARTHQUAKE, SURF, SLUDGE_BOMB, RAIN_DANCE
	db 64, MEGANIUM,    MIRACLE_SEED,    REFLECT, GIGA_DRAIN, SOLARBEAM, BODY_SLAM
	db 64, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end

	; RIVAL2 (6) - vs Smeargle: Speed/special
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 64, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 64, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 64, ALAKAZAM,    SCOPE_LENS,      PSYCHIC_M, RECOVER, FIRE_PUNCH, THUNDER_WAVE
	db 64, HOUNDOOM,    CHARCOAL,        FIRE_BLAST, IRON_TAIL, CRUNCH, SUNNY_DAY
	db 64, TYPHLOSION,  QUICK_CLAW,      FIRE_BLAST, THUNDERPUNCH, QUICK_ATTACK, IRON_TAIL
	db 64, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end

	; RIVAL2 (7) - vs Swinub: Water/Fire cover
	db "?@", TRAINERTYPE_ITEM_MOVES
	db 64, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 64, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, WING_ATTACK
	db 64, MAGMAR,      CHARCOAL,        FIRE_BLAST, THUNDERPUNCH, CONFUSE_RAY, CROSS_CHOP
	db 64, OCTILLERY,   NEVERMELTICE,    SURF, ICE_BEAM, PSYBEAM, HYPER_BEAM
	db 64, FERALIGATR,  MYSTIC_WATER,    ICE_BEAM, SURF, SLASH, EARTHQUAKE
	db 64, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
	...
	db 68, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 68, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, FLY
	db 68, MACHAMP,     SCOPE_LENS,      CROSS_CHOP, ROCK_SLIDE, FORESIGHT, VITAL_THROW
	db 68, STEELIX,     QUICK_CLAW,      EARTHQUAKE, IRON_TAIL, ROCK_SLIDE, SCREECH
	db 68, FERALIGATR,  MYSTIC_WATER,    ICE_BEAM, SURF, SLASH, EARTHQUAKE
	db 68, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
	...
	db 68, VICTREEBEL,  SCOPE_LENS,      SLUDGE_BOMB, GIGA_DRAIN, SLEEP_POWDER, GROWTH
	db 68, QUAGSIRE,    QUICK_CLAW,      EARTHQUAKE, SURF, SLUDGE_BOMB, RAIN_DANCE
	db 68, MEGANIUM,    MIRACLE_SEED,    REFLECT, GIGA_DRAIN, SOLARBEAM, BODY_SLAM
	db 68, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
	...
	db 68, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 68, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, FLY
	db 68, ALAKAZAM,    SCOPE_LENS,      PSYCHIC_M, RECOVER, FIRE_PUNCH, THUNDER_WAVE
	db 68, HOUNDOOM,    CHARCOAL,        FIRE_BLAST, IRON_TAIL, CRUNCH, SUNNY_DAY
	db 68, TYPHLOSION,  QUICK_CLAW,      FIRE_BLAST, THUNDERPUNCH, QUICK_ATTACK, IRON_TAIL
	db 68, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
	...
	db 68, URSARING,    SCOPE_LENS,      SLASH, FAINT_ATTACK, ROCK_SMASH, HYPER_BEAM
	db 68, CROBAT,      LEFTOVERS,       TOXIC, DOUBLE_TEAM, CONFUSE_RAY, FLY
	db 68, MAGMAR,      CHARCOAL,        FIRE_BLAST, THUNDERPUNCH, CONFUSE_RAY, CROSS_CHOP
	db 68, OCTILLERY,   NEVERMELTICE,    SURF, ICE_BEAM, PSYBEAM, HYPER_BEAM
	db 68, FERALIGATR,  MYSTIC_WATER,    ICE_BEAM, SURF, SLASH, EARTHQUAKE
	db 68, TYRANITAR,   NO_ITEM,         CRUNCH, EARTHQUAKE, ROCK_SLIDE, FIRE_BLAST
	db -1 ; end
...
HikerGroup:
	...
	; TIMOTHY_V1
	db "TIMOTHY@", TRAINERTYPE_MOVES
	db 38, SANDSLASH, SLASH, EARTHQUAKE, SAND_ATTACK, SWIFT
	db 39, DONPHAN, ROLLOUT, EARTHQUAKE, DEFENSE_CURL, TAKE_DOWN
	db 38, GOLEM, MAGNITUDE, ROCK_THROW, ROLLOUT, DEFENSE_CURL
	db 38, MAROWAK, BONEMERANG, HEADBUTT, LEER, THRASH
	db -1 ; end
	; TIMOTHY_V2
	db "TIMOTHY@", TRAINERTYPE_MOVES
	db 39, STEELIX, IRON_TAIL, DIG, ROCK_THROW, SANDSTORM
	db 39, MACHAMP, KARATE_CHOP, VITAL_THROW, ROCK_SLIDE, SCARY_FACE
	db 39, GOLEM, MAGNITUDE, ROCK_THROW, ROLLOUT, SELFDESTRUCT
	db -1 ; end
...
BurglarGroup:
	...
	; EDDIE_V1
	db "EDDIE@", TRAINERTYPE_MOVES
	db 35, HOUNDOOM, FLAMETHROWER, BITE, SMOG, ROAR
	db 35, KOFFING, SLUDGE, SMOKESCREEN, SELFDESTRUCT, TACKLE
	db -1 ; end
	; EDDIE_V2
	db "EDDIE@", TRAINERTYPE_MOVES
	db 36, ARCANINE, FLAMETHROWER, BITE, TAKE_DOWN, ROAR
	db -1 ; end
...
BlackbeltGroup:
	...
	; YOSHI_V1
	db "YOSHI@", TRAINERTYPE_MOVES
	db 29, MACHOKE, KARATE_CHOP, SEISMIC_TOSS, LEER, ROCK_SLIDE
	db -1 ; end
	; YOSHI_V2
	db "YOSHI@", TRAINERTYPE_MOVES
	db 28, MACHOP, KARATE_CHOP, LOW_KICK, LEER, SEISMIC_TOSS
	db 28, PRIMEAPE, LOW_KICK, FURY_SWIPES, KARATE_CHOP, RAGE
	db -1 ; end
	; LAO_V1
	db "LAO@", TRAINERTYPE_MOVES
	db 29, PRIMEAPE, LOW_KICK, KARATE_CHOP, FURY_SWIPES, SEISMIC_TOSS
	db -1 ; end
	; LAO_V2
	db "LAO@", TRAINERTYPE_MOVES
	db 28, MACHOKE, VITAL_THROW, KARATE_CHOP, LEER, ROCK_SLIDE
	db 28, MANKEY, LOW_KICK, KARATE_CHOP, FURY_SWIPES, RAGE
	db -1 ; end
	; NOB_V1
	db "NOB@", TRAINERTYPE_MOVES
	db 27, PRIMEAPE, LOW_KICK, FURY_SWIPES, KARATE_CHOP, SEISMIC_TOSS
	db 27, MANKEY, LOW_KICK, KARATE_CHOP, FURY_SWIPES, RAGE
	db -1 ; end
	; NOB_V2
	db "NOB@", TRAINERTYPE_MOVES
	db 28, MACHOKE, KARATE_CHOP, SEISMIC_TOSS, LEER, VITAL_THROW
	db -1 ; end
	; LUNG_V1
	db "LUNG@", TRAINERTYPE_NORMAL
	db 27, MACHOP
	...
	; KENJI3_V1
	db "KENJI@", TRAINERTYPE_MOVES
	db 33, PRIMEAPE, LOW_KICK, FURY_SWIPES, KARATE_CHOP, SEISMIC_TOSS
	db 33, MACHOKE, VITAL_THROW, ROCK_SLIDE, LEER, SEISMIC_TOSS
	db -1 ; end
	; KENJI3_V2
	db "KENJI@", TRAINERTYPE_MOVES
	db 34, MACHAMP, CROSS_CHOP, ROCK_SLIDE, SCARY_FACE, VITAL_THROW
	db -1 ; end
...
PsychicGroup:
	...
	; NORMAN_V1
	db "NORMAN@", TRAINERTYPE_MOVES
	db 22, DROWZEE, HYPNOSIS, DISABLE, HEADBUTT, CONFUSION
	db 23, GIRAFARIG, STOMP, PSYBEAM, AGILITY, CONFUSION
	db -1 ; end
	; NORMAN_V2
	db "NORMAN@", TRAINERTYPE_MOVES
	db 23, KADABRA, CONFUSION, PSYBEAM, KINESIS, RECOVER
	db -1 ; end
	; MARK_V1
	db "MARK@", TRAINERTYPE_MOVES
	...
	; PHIL_V1
	db "PHIL@", TRAINERTYPE_MOVES
	db 36, HYPNO, HYPNOSIS, DREAM_EATER, HEADBUTT, PSYCHIC_M
	db 36, ALAKAZAM, PSYCHIC_M, RECOVER, SHADOW_BALL, NO_MOVE
	db 36, SLOWBRO, SURF, PSYCHIC_M, AMNESIA, HEADBUTT
	db -1 ; end
	; PHIL_V2
	db "PHIL@", TRAINERTYPE_MOVES
	db 37, ESPEON, PSYCHIC_M, SWIFT, MORNING_SUN, SHADOW_BALL
...
PicnickerGroup:
	...
	; BROOKE_V1
	db "BROOKE@", TRAINERTYPE_MOVES
	db 22, CLEFAIRY, POUND, GROWL, ENCORE, DOUBLESLAP
	db -1 ; end
	; BROOKE_V2
	...
	; TIFFANY1_V1
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 34, WIGGLYTUFF, SING, BODY_SLAM, DEFENSE_CURL, ROLLOUT
	db 34, CLEFABLE, METRONOME, ENCORE, DOUBLESLAP, MOONLIGHT
	db -1 ; end
	; TIFFANY1_V2
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 35, GRANBULL, HEADBUTT, BITE, SCARY_FACE, STRENGTH
	db -1 ; end
	; ERIN1_V1
	db "ERIN@", TRAINERTYPE_NORMAL
	db 40, ARCANINE
