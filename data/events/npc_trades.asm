...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_HAPPY,     KRABBY,     SNEASEL,    "SLASH@@@@@@", $98, $88, NEVERMELTICE, 29189, "TIM@@@@@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_GIRL,      POLIWHIRL,  DRATINI,    "NESSIE@@@@@", $77, $66, DRAGON_SCALE,  00283, "EMY@@@@@@@@", TRADE_GENDER_FEMALE
...
; Note: Kyle (1), Mike (0), Tim (2), and Emy (3) use dynamic species - see engine/events/npc_trade.asm
