	...
	; tm/hm learnset
	tmhm CURSE, ROLLOUT, TOXIC, PSYCH_UP, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, GIGA_DRAIN, ENDURE, FRUSTRATION, SOLARBEAM, RETURN, PSYCHIC_M, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SLUDGE_BOMB, DREAM_EATER, REST, ATTRACT, THIEF, NIGHTMARE, STRENGTH, FLASH, DOUBLE_EDGE, REFLECT, MEGA_DRAIN, SUBSTITUTE, EXPLOSION, MIMIC, PSYWAVE, SELFDESTRUCT, TELEPORT, TAKE_DOWN, RAGE, BIDE, EGG_BOMB
	; end
