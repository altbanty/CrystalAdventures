	...
	; tm/hm learnset
	tmhm DYNAMICPUNCH, HEADBUTT, CURSE, ROLLOUT, TOXIC, ROCK_SMASH, HIDDEN_POWER, SUNNY_DAY, SNORE, PROTECT, ENDURE, FRUSTRATION, EARTHQUAKE, RETURN, DIG, MUD_SLAP, DOUBLE_TEAM, SWAGGER, SLEEP_TALK, SANDSTORM, FIRE_BLAST, DEFENSE_CURL, REST, ATTRACT, FIRE_PUNCH, STRENGTH, FLAMETHROWER, DOUBLE_EDGE, SUBMISSION, SUBSTITUTE, EXPLOSION, MEGA_PUNCH, BODY_SLAM, ROCK_SLIDE, COUNTER, MIMIC, SEISMIC_TOSS, SELFDESTRUCT, METRONOME, TAKE_DOWN, RAGE, BIDE
	; end
