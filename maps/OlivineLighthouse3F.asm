...
OlivineLighthouse3FEther:
	randomized_item_5 ETHER, ELIXER, MAX_POTION, REVIVE, SUPER_REPEL
...
OlivineLighthouse3F_MapEvents:
	...
	object_event  8,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse3FEther, EVENT_OLIVINE_LIGHTHOUSE_3F_ETHER
