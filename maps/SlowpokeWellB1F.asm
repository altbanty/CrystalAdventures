...
SlowpokeWellB1FSuperPotion:
	randomized_item_5 SUPER_POTION, ANTIDOTE, REPEL, AWAKENING, POKE_BALL
...
SlowpokeWellB1F_MapEvents:
	...
	object_event 10,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SlowpokeWellB1FSuperPotion, EVENT_SLOWPOKE_WELL_B1F_SUPER_POTION
