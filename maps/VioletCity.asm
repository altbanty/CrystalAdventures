...
VioletCityPPUp:
	randomized_item_5 PP_UP, RARE_CANDY, ETHER, NUGGET, PROTEIN

VioletCityRareCandy:
	randomized_item_5 RARE_CANDY, PP_UP, NUGGET, CALCIUM, BIG_PEARL
...
VioletCity_MapEvents:
	...
	object_event  4,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletCityPPUp, EVENT_VIOLET_CITY_PP_UP
	object_event 35,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, VioletCityRareCandy, EVENT_VIOLET_CITY_RARE_CANDY
