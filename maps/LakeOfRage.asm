...
LakeOfRageElixer:
	randomized_item_5 ELIXER, MAX_ETHER, HYPER_POTION, ULTRA_BALL, BIG_PEARL

LakeOfRageTMDetect:
	randomized_item_5 TM_SWORDS_DANCE, TM_PROTECT, TM_RETURN, DRAGON_SCALE, RARE_CANDY
...
LakeOfRage_MapEvents:
	...
	object_event  7, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageElixer, EVENT_LAKE_OF_RAGE_ELIXER
	object_event 35,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LakeOfRageTMDetect, EVENT_LAKE_OF_RAGE_TM_DETECT
