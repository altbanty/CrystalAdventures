...
Route44MaxRevive:
	randomized_item_5 MAX_REVIVE, FULL_RESTORE, MAX_ELIXER, RARE_CANDY, TM_BODY_SLAM

Route44UltraBall:
	randomized_item_5 ULTRA_BALL, HYPER_POTION, MAX_REPEL, REVIVE, RARE_CANDY

Route44MaxRepel:
	randomized_item_5 MAX_REPEL, ULTRA_BALL, FULL_HEAL, ELIXER, PEARL
...
Route44_MapEvents:
	...
	object_event 30,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44MaxRevive, EVENT_ROUTE_44_MAX_REVIVE
	object_event 45,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44UltraBall, EVENT_ROUTE_44_ULTRA_BALL
	object_event 14,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route44MaxRepel, EVENT_ROUTE_44_MAX_REPEL
