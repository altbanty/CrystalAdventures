...
Route35TMRollout:
	randomized_item_5 TM_ROLLOUT, THUNDERSTONE, TM_PROTECT, LEAF_STONE, TM_TAKE_DOWN
...
Route35_MapEvents:
	...
	object_event 13, 16, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route35TMRollout, EVENT_ROUTE_35_TM_ROLLOUT
