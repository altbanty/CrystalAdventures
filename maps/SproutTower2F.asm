...
SproutTower2FXAccuracy:
	randomized_item_5 PEARL, BIG_PEARL, NUGGET, REVIVE, TINYMUSHROOM
...
SproutTower2F_MapEvents:
	...
	object_event  3,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SproutTower2FXAccuracy, EVENT_SPROUT_TOWER_2F_X_ACCURACY
