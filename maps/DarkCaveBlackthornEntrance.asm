...
DarkCaveBlackthornEntranceRevive:
	randomized_item_5 REVIVE, MAX_POTION, ULTRA_BALL, ELIXER, NUGGET

DarkCaveBlackthornEntranceTMSnore:
	randomized_item_5 TM_SNORE, TM_NIGHTMARE, TM_DREAM_EATER, BLACKBELT_I, CARBOS
...
DarkCaveBlackthornEntrance_MapEvents:
	...
	object_event 21, 24, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DarkCaveBlackthornEntranceRevive, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_REVIVE
	object_event  7, 22, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, DarkCaveBlackthornEntranceTMSnore, EVENT_DARK_CAVE_BLACKTHORN_ENTRANCE_TM_SNORE
