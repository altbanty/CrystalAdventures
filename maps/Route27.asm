...
Route27TMSolarbeam:
	randomized_item_5 TM_SOLARBEAM, TM_THUNDER, TM_BLIZZARD, TM_FIRE_BLAST, TM_EARTHQUAKE
...
Route27_MapEvents:
	...
	object_event 60, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route27TMSolarbeam, EVENT_ROUTE_27_TM_SOLARBEAM
	object_event 53, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route27RareCandy, EVENT_ROUTE_27_RARE_CANDY
