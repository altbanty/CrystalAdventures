...
Route32GreatBall:
	randomized_item_4 SUPER_POTION, GREAT_BALL, MAX_ETHER, REPEL
...
Route32_MapEvents:
	...
	object_event 19,  8, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route32MiracleSeed, EVENT_GOT_MIRACLE_SEED_IN_ROUTE_32
