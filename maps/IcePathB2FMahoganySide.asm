...
IcePathB2FMahoganySideFullHeal:
	randomized_item_5 FULL_HEAL, MAX_POTION, REVIVE, ULTRA_BALL, ELIXER

IcePathB2FMahoganySideMaxPotion:
	randomized_item_5 MAX_POTION, FULL_RESTORE, HYPER_POTION, MAX_REVIVE, NUGGET
...
IcePathB2FMahoganySide_MapEvents:
	...
	object_event  8,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IcePathB2FMahoganySideFullHeal, EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_FULL_HEAL
	object_event  0,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, IcePathB2FMahoganySideMaxPotion, EVENT_ICE_PATH_B2F_MAHOGANY_SIDE_MAX_POTION
