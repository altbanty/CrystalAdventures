...
BurnedTowerB1FTMEndure:
	randomized_item_5 TM_COUNTER, TM_DETECT, SPELL_TAG, CALCIUM, RARE_CANDY
...
BurnedTowerB1F_MapEvents:
	...
	object_event 16,  4, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BurnedTowerB1FTMEndure, EVENT_BURNED_TOWER_B1F_TM_ENDURE
