...
GoldenrodDeptStoreB1FEther:
	randomized_item_5 ETHER, ELIXER, SUPER_POTION, PEARL, REVIVE

GoldenrodDeptStoreB1FAmuletCoin:
	randomized_item_5 AMULET_COIN, QUICK_CLAW, SCOPE_LENS, LEFTOVERS, FOCUS_BAND

GoldenrodDeptStoreB1FBurnHeal:
	randomized_item_5 BRICK_PIECE, NUGGET, BIG_PEARL, STAR_PIECE, BIG_MUSHROOM

GoldenrodDeptStoreB1FUltraBall:
	randomized_item_5 ULTRA_BALL, GREAT_BALL, HYPER_POTION, FULL_HEAL, PROTEIN
...
GoldenrodDeptStoreB1F_MapEvents:
	...
	def_object_events
	object_event 10, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FEther, EVENT_GOLDENROD_DEPT_STORE_B1F_ETHER
	object_event 14,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FAmuletCoin, EVENT_GOLDENROD_DEPT_STORE_B1F_AMULET_COIN
	object_event  6,  3, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FBurnHeal, EVENT_GOLDENROD_DEPT_STORE_B1F_BURN_HEAL
	object_event 15, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodDeptStoreB1FUltraBall, EVENT_GOLDENROD_DEPT_STORE_B1F_ULTRA_BALL
