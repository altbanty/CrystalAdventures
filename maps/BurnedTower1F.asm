...
BurnedTower1FHPUp:
	randomized_item_5 HP_UP, PROTEIN, CHARCOAL, TM_ENDURE, NUGGET
...
BurnedTower1F_MapEvents:
	...
	object_event 14,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, BurnedTower1FHPUp, EVENT_BURNED_TOWER_1F_HP_UP
