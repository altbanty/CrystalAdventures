...
TinTower9FHPUp:
	randomized_item_5 HP_UP, PROTEIN, IRON, CALCIUM, CARBOS
...
TinTower9F_MapEvents:
	...
	def_object_events
	object_event  9,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TinTower9FHPUp, EVENT_TIN_TOWER_9F_HP_UP
