...
OlivineLighthouse5FRareCandy:
	randomized_item_5 RARE_CANDY, PP_UP, NUGGET, CALCIUM, HP_UP

OlivineLighthouse5FSuperRepel:
	randomized_item_5 SUPER_REPEL, HYPER_POTION, GREAT_BALL, FULL_HEAL, PEARL

OlivineLighthouse5FTMSwagger:
	randomized_item_5 TM_SWAGGER, TM_ATTRACT, MAGNET, IRON, BIG_PEARL
...
OlivineLighthouse5F_MapEvents:
	...
	object_event 15, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse5FRareCandy, EVENT_OLIVINE_LIGHTHOUSE_5F_RARE_CANDY
	object_event  6, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse5FSuperRepel, EVENT_OLIVINE_LIGHTHOUSE_5F_SUPER_REPEL
	object_event  2, 13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineLighthouse5FTMSwagger, EVENT_OLIVINE_LIGHTHOUSE_5F_TM_SWAGGER
