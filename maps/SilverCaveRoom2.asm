...
SilverCaveRoom2UltraBall:
	randomized_item_5 ULTRA_BALL, FULL_RESTORE, MAX_REVIVE, MAX_ELIXER, RARE_CANDY

SilverCaveRoom2PPUp:
	randomized_item_5 PP_UP, FULL_RESTORE, RARE_CANDY, MAX_ELIXER, LEFTOVERS
...
SilverCaveRoom2_MapEvents:
	...
	def_object_events
	object_event 24, 10, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2Calcium, EVENT_SILVER_CAVE_ROOM_2_CALCIUM
	...
	object_event  4, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SilverCaveRoom2PPUp, EVENT_SILVER_CAVE_ROOM_2_PP_UP