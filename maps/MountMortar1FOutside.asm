...
MountMortar1FOutsideTMDefenseCurl:
	randomized_item_5 TM_DEFENSE_CURL, TM_ROLLOUT, HARD_STONE, BLACKBELT_I, IRON

MountMortar1FOutsideRevive:
	randomized_item_5 REVIVE, HYPER_POTION, ULTRA_BALL, ELIXER, PEARL
...
MountMortar1FOutside_MapEvents:
	...
	object_event 13, 15, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MountMortar1FOutsideTMDefenseCurl, EVENT_MOUNT_MORTAR_2F_INSIDE_TM_DEFENSE_CURL
	object_event 31, 18, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MountMortar1FOutsideRevive, EVENT_MOUNT_MORTAR_1F_OUTSIDE_REVIVE
