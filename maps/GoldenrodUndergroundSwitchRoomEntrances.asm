...
GoldenrodUndergroundSwitchRoomEntrancesSmokeBall:
	randomized_item_5 SMOKE_BALL, QUICK_CLAW, BRIGHTPOWDER, FOCUS_BAND, NUGGET

GoldenrodUndergroundSwitchRoomEntrancesFullHeal:
	randomized_item_5 FULL_HEAL, SUPER_POTION, REVIVE, GREAT_BALL, PEARL
...
GoldenrodUndergroundSwitchRoomEntrances_MapEvents:
	...
	object_event  1, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundSwitchRoomEntrancesSmokeBall, EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_SMOKE_BALL
	object_event 14,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GoldenrodUndergroundSwitchRoomEntrancesFullHeal, EVENT_GOLDENROD_UNDERGROUND_SWITCH_ROOM_ENTRANCES_FULL_HEAL
