...
MartTier3TMs: ; 32 TMs - $2,500
	db TM_HEADBUTT, TM_ROLLOUT, TM_ROAR, TM_ROCK_SMASH
	db TM_HIDDEN_POWER, TM_SUNNY_DAY, TM_SNORE, TM_ICY_WIND
	db TM_RAIN_DANCE, TM_ENDURE, TM_FRUSTRATION, TM_MUD_SLAP, TM_DOUBLE_TEAM
	db TM_SANDSTORM, TM_SWIFT, TM_DEFENSE_CURL, TM_DREAM_EATER
	db TM_ATTRACT, TM_THIEF, TM_FURY_CUTTER, TM_NIGHTMARE
	; Gen 1 T3 TMs
	db TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_DRAGON_RAGE
	db TM_WHIRLWIND, TM_PSYWAVE, TM_HORN_DRILL
	; Phase 2 Gen 1 TMs
...
MartTier2TMs: ; 30 TMs - $5,000
	...
	db TM_FIRE_PUNCH
	; Gen 1 T2 TMs
	db TM_COUNTER, TM_SEISMIC_TOSS, TM_SOFTBOILED, TM_SELFDESTRUCT
...
MartTier1TMs: ; 17 TMs - $10,000
	...
	; Gen 1 T1 TMs
	db TM_BODY_SLAM, TM_SWORDS_DANCE, TM_THUNDER_WAVE, TM_ROCK_SLIDE
	db TM_SUBSTITUTE, TM_DOUBLE_EDGE, TM_REFLECT, TM_EXPLOSION
